...
## Project Structure
    ...
    ├── samuel_test_staging_tf_1  # Django project configurations
...
1. Clone this repo and `cd samuel_test_staging_tf_1`
...
2. Clone this repo and `cd samuel_test_staging_tf_1`
